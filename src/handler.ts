...
const routes = [
  ...
  { route: new Route('/t/:id/video.mp4'), method: 'GET', handler: VideoFromShare, args: [true] },
  { route: new Route('/t/:id/thumb.jpeg'), method: 'GET', handler: ThumbnailFromShare },
  ...
  { route: new Route('/t/:id'), method: 'GET', handler: VideoFromShare },
